...
const Banner = () => {
  return (
    <div className="section-padding-x flex flex-col-reverse dark:bg-[#0B1120] lg:flex-row items-center justify-between py-12 lg:py-20 gap-10 lg:gap-16">
      {/* Left Text Section */}
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-end gap-4">
        <div className="relative max-w-[550px] w-full">
          ...
          <p className="text-Tertiary dark:text-white text-sm lg:text-base  ">
