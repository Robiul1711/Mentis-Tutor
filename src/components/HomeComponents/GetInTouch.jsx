...
const GetInTouch = () => {
  ...
  return (
    <div className="py-14   section-padding-x">
          ...
          <div className="flex flex-col gap-4 max-w-[800px] mx-auto text-center">
            ...
            <Title level="title20">
            Have questions about our courses, pricing, or support? Reach out and we’ll respond quickly to help you succeed in your GCSE Maths journey.
            </Title>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border rounded-md text-base bg-bg-custom1 outline-none focus:ring-2 focus:ring-blue-500"
            />
  ...
  <CommonButton variant="secondary" className="mt-6 w-full "> Send Message </CommonButton>
