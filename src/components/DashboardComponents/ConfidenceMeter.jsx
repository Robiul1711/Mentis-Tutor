...
export default function ConfidenceMeter() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 xl:p-8 bg-white dark:bg-[#0B1120] dark:text-white dark:border rounded-lg shadow-sm">
      <h1 className="xl:text-3xl text-xl font-semibold text-gray-800 mb-4 xl:mb-8 dark:text-white">Confidence Meter</h1>
      
      {/* Stats Display */}
      <div className="flex justify-between items-center xl:mb-8 mb-2 flex-wrap gap-3 xl:gap-4 dark:text-white">
      ...
      {/* Donut Chart */}
      <div className="flex justify-center mb-2 xl:mb-8">
      ...
      {/* Legend */}
      <div className="flex gap-4 xl:gap-8 mb-4 xl:mb-8 flex-wrap">
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded-full bg-green-600"></div>
          <span className="text-gray-700 dark:text-white">Confident</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded-full bg-amber-500"></div>
          <span className="text-gray-700 dark:text-white">Ok</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded-full bg-red-500"></div>
          <span className="text-gray-700 dark:text-white">Need Work</span>
        </div>
      </div>
