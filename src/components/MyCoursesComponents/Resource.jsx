  ...
  return (
    <div className="space-y-4">
      ...
      <div className="w-full flex gap-10 mt-8 ">
        ...
        <div className="w-[60%]">
          <div className="p-5 bg-bg-custom1 rounded-2xl">
            <Title level="title24">Documents</Title>
            <div className="bg-white flex gap-4 rounded-2xl mt-7 p-6">
              <button className="py-3 px-4 rounded-2xl border transition duration-300 bg-[#64B5F6]/10 text-black hover:bg-gray-100 flex gap-2">
                <PdfIcon className="w-6 h-6 text-black" /> Book-Brochure.pdf
              </button>
              <button className="py-3 px-4 rounded-2xl border transition duration-300 bg-[#64B5F6]/10 text-black hover:bg-gray-100 flex gap-2">
                <PdfIcon className="w-6 h-6 text-black" /> Book-Brochure.pdf
              </button>
