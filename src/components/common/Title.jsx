...
const sizeMap = {
 title64: "text-[34px] sm:text-[48px] md:text-[56px] lg:text-[64px] font-bold",
  title56: "text-[30px] sm:text-[42px] md:text-[50px] lg:text-[56px] font-semibold sm:font-bold md:font-extrabold",
  title48: "text-xl sm:text-2xl md:text-3xl xl:text-[48px] font-bold",
