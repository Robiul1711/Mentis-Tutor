...
const sizeMap = {
  ...
  title22: "text-[14px] sm:text-[16px] md:text-[18px] xl:text-[22px] font-medium",
  title20: "text-[13px] sm:text-[15px] md:text-[18px] xl:text-[20px] font-normal",
  title18: "text-[12px] sm:text-[14px] md:text-[16px] xl:text-[18px] font-normal",
  title16: "text-[11px] sm:text-[13px] md:text-[14px] xl:text-[16px] font-normal",
  title14: "text-[10px] sm:text-[12px] md:text-[13px] xl:text-[14px] font-normal",
  title12: "text-[10px] sm:text-[11px] md:text-[12px] xl:text-[13px] font-normal",
};
