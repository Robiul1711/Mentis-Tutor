...
const AbourHero = () => {
  return (
    <div className="flex w-full gap-10 flex-col lg:flex-row section-padding-x py-10 bg-bg-custom1">
      {/* Left Image Section */}
      ...
      <div className="w-full lg:w-1/2 flex flex-col space-y-6 text-center lg:text-left mt-8 lg:mt-0">
        ...
        <div className="flex justify-center lg:justify-start">
          <ul className="flex flex-col gap-3 text-Secondary text-xl font-semibold">
